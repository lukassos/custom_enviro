...
last="`pwd`"
cd ~/Downloads
wget -c https://download.jetbrains.com/python/pycharm-community-2016.3.1.tar.gz -O pycharm-community-2016.3.1.tar.gz 
tar -xvzf pycharm-community-2016.3.1.tar.gz  -C ~
rm -rf pycharm-community-2016.3.1.tar.gz 
cd $last